        ...
        playPauseIB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(videoView.isPlaying()){
                    videoView.pause();
                    playPauseIB.setImageDrawable(getResources().getDrawable(R.drawable.baseline_play_circle_24));
                }else{
                    videoView.start();
                    playPauseIB.setImageDrawable(getResources().getDrawable(R.drawable.pause_circle_outline_24));
                }
            }
        });
